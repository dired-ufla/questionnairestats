...
$string['lb_amount_of_students_responses'] = 'Amount of responses/students';
...
$string['lb_link_csv'] = 'Export summary to CSV file';
$string['lb_link_csv_responses'] = 'Export responses to CSV file';
$string['lb_shortname'] = 'Short name';
$string['lb_fullname'] = 'Full name';
$string['lb_feedbackname'] = 'Questionnarie';
$string['lb_department'] = 'Department';
$string['lb_teacher'] = 'Teacher(s)';
